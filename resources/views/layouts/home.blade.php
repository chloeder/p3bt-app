...
<head>
    ...
    <title>Kantor ATR/BPN Kotamobagu</title>
    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="{{ asset('img/logo-p3bt.png') }}" rel="icon">
...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="logo">
                {{-- <h1 class="text-light"><a href="index.html"><span>P3BT APP</span></a></h1> --}}
                <img src="{{ asset('img/logo-p3bt.png') }}" alt="" class="img-fluid">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="#services">Pelayanan Kami</a></li>

                    <li><a class="nav-link scrollto" href="#contact">Hubungi Kami</a></li>
                    <li><a class="getstarted scrollto" href="{{ route('validasi') }}">Cek Validasi</a></li>
                </ul>
